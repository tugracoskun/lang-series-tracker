...
const FlashcardsPage = ({ onBack }) => {
    return (
        <div className="pb-20">
            ...
            <div className="glass-panel text-center py-32 rounded-3xl">
                <div className="w-24 h-24 bg-indigo-500/10 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse">
